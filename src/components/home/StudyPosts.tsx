    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-base font-bold text-gray-800">Bài đăng kết nối học tập</h2>
          <button
            onClick={onAddPost}
            className="inline-flex items-center gap-1.5 rounded-xl bg-orange-600 px-3.5 py-2 text-xs font-semibold text-white hover:bg-orange-700 shadow-xs transition-colors cursor-pointer"
          >
            <Plus size={14} />
            Đăng bài
          </button>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={onAddPost}
          className="inline-flex items-center gap-1.5 rounded-xl bg-[#3b82f6] px-3.5 py-2 text-xs font-semibold text-white hover:bg-[#4aa2f6] shadow-xs transition-colors cursor-pointer"
        >
          <Plus size={14} />
          Đăng bài
        </button>
