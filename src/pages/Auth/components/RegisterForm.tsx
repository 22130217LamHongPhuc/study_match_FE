  ...
  return (
    <div className="relative rounded-[28px] bg-white p-8 overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <button
          type="submit"
          className="w-full rounded-lg bg-accent-500 py-3 text-base font-medium text-white transition hover:bg-accent-600 mt-2"
        >
          Tạo tài khoản
        </button>
      </form>
      ...
      <div className="mt-6 text-center">
        <p className="mt-10 text-center text-sm text-slate-500 md:text-base">
          ...
          <Link
            to="/login"
            className="ml-1 font-bold text-accent-500 cursor-pointer hover:text-accent-600 transition-colors"
          >
            Đăng nhập ngay
          </Link>
        </p>
