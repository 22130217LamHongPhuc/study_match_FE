...
export default function ConversationPage() {
  ...
  const [waitingVideoCall, setWaitingVideoCall] =
    useState<VideoCallInfo | null>(null);
  ...
  const markLatestIncomingSeen = (
    ...
    if (
      ...
      latestIncomingMessageId <= lastSeenMessageIdRef.current
    )
      return;
  ...
  useLayoutEffect(() => {
    const loadMess = async () => {
      ...
      try {
        ...
        console.warn(
          "đây là conversationId sau khi loadMess",
  ...
  const hasConversationId = (
    ...
    return !!data && typeof data === "object" && "conversationId" in data;
  };
