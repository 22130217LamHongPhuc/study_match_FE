    ...
    <main className="min-h-screen bg-blue-50/30 px-6 py-8 sm:px-8 lg:px-10">
      <div className="mx-auto w-full max-w-7xl flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-5 items-stretch">
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm lg:col-span-3 flex flex-col justify-between">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm lg:col-span-2 flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed mb-4">
                Tỷ lệ chuyên cần được tính dựa trên số buổi học bạn **Đã tham gia** chia cho tổng số buổi học bạn được mời (không tính các buổi đã từ chối).
              </p>
              <div className="space-y-3 text-xs text-gray-600">
                <div className="flex items-start gap-2">
                  <span className="h-2 w-2 rounded-full bg-emerald-500 shrink-0 mt-1.5" />
                  <p>
                    <span className="font-semibold text-gray-700">Chăm chỉ (≥ 80%):</span> Học tập chuyên cần, tham gia đầy đủ.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="h-2 w-2 rounded-full bg-amber-500 shrink-0 mt-1.5" />
                  <p>
                    <span className="font-semibold text-gray-700">Trung bình (50% - 79%):</span> Tham gia chưa đều, cần cố gắng hơn.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="h-2 w-2 rounded-full bg-rose-500 shrink-0 mt-1.5" />
                  <p>
                    <span className="font-semibold text-gray-700">Báo động (&lt; 50%):</span> Vắng mặt quá nhiều, hãy chủ động liên hệ nhóm học!
                  </p>
                </div>
              </div>
